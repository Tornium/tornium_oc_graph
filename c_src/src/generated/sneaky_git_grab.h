...
{"_A2_C1_", Node([](const SuccessMap &m){ return (m.at("pickpocket_1") + m.at("pickpocket_1"))/2; }, "_A3_C1_", "_A2_C2_")},
{"_A2_C2_", Node([](const SuccessMap &m){ return m.at("pickpocket_1"); }, "_A3_C1_", "_A2F_")},
{"_A3F_", TerminalNode(0)},
{"_A3_C1_", Node([](const SuccessMap &m){ return (m.at("pickpocket_1") + m.at("imitator_1"))/2; }, "_A4_C1_", "_A3_C2_")},
{"_A3_C2_", Node([](const SuccessMap &m){ return m.at("imitator_1"); }, "_A4_C1_", "_A3_C3_")},
{"_A3_C3_", Node([](const SuccessMap &m){ return (m.at("pickpocket_1") + m.at("pickpocket_1"))/2; }, "_A4_C1_", "_A3F_")},
...
{"_A4_C2_", Node([](const SuccessMap &m){ return m.at("pickpocket_1"); }, "_A5_C1_", "_A4F_")},
...
{"_A5_C3_", Node([](const SuccessMap &m){ return (m.at("imitator_1") + m.at("hacker_1"))/2; }, "_B6_C1_", "_A5F_")},
{"_A6_C1_", Node([](const SuccessMap &m){ static_assert(false, "Missing data: This needs to be manually entered"); }, "_A7_C1_", "_A6_C2_")},
{"_A6_C2_", Node([](const SuccessMap &m){ return (m.at("imitator_1") + m.at("hacker_1"))/2; }, "_A8S_", "_A9S_")},
