...
{"START", Node([](const SuccessMap &m){ return (m.at("robber_1") + m.at("muscle_1"))/2; }, "_A2_C1_", "_A1_C2_")},
...
{"_A2_C1_", Node([](const SuccessMap &m){ return (m.at("muscle_2") + m.at("thief_1"))/2; }, "_A3_C1_", "_A2_C2_")},
{"_A2_C2_", Node([](const SuccessMap &m){ return (m.at("muscle_2") + m.at("thief_1"))/2; }, "_A3_C1_", "_B1_C1_")},
{"_A3_C1_", Node([](const SuccessMap &m){ return m.at("muscle_3"); }, "_A4_C1_", "_A3_C2_")},
{"_A3_C2_", Node([](const SuccessMap &m){ return (m.at("thief_2") + m.at("muscle_3"))/2; }, "_A4_C1_", "_A4_C2_")},
...
{"_A5_C2_", Node([](const SuccessMap &m){ return (m.at("muscle_3") + m.at("muscle_1"))/2; }, "_A6_C1_", "_A5F_")},
{"_A6_C1_", Node([](const SuccessMap &m){ return (m.at("robber_1") + m.at("muscle_1"))/2; }, "_A7_C1_", "_A7_C2_")},
{"_A7_C1_", Node([](const SuccessMap &m){ return (m.at("muscle_1") + m.at("robber_1"))/2; }, "_A8_C1_", "_A7_C2_")},
