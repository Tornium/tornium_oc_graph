...
inline const NodeMap first_aid_and_abet{
    ...
    return (sm_position(m, "decoy_1") + sm_position(m, "pickpocket_1")) / 2;
}, "_A7S3_", "_A6F_"}},
    {"_A1_C3_", Node{[](const SuccessMap &m) {
    return (sm_position(m, "pickpocket_1") + sm_position(m, "picklock_1")) / 2;
}, "_A2_C1_", "_A1F_"}},
    {"_B6_C1_", Node{[](const SuccessMap &m) { return sm_position(m, "decoy_1"); }, "_B7S_", "_B6_C2_"}},
    {"_B4_C2_", Node{[](const SuccessMap &m) {
    return (sm_position(m, "picklock_1") + sm_position(m, "decoy_1") + sm_position(m, "picklock_1")) / 3;
}, "_B5_C1_", "_B4F_"}},
    ...
    {"_B3_C1_", Node{[](const SuccessMap &m) {
    return (sm_position(m, "decoy_1") + sm_position(m, "pickpocket_1")) / 2;
}, "_B4_C1_", "_B3F_"}},
    {"_A5_C2_", Node{[](const SuccessMap &m) { return sm_position(m, "decoy_1"); }, "_A6_C1_", "_A5_C3_"}},
    {"_A6_C1_", Node{[](const SuccessMap &m) { return (sm_position(m, "picklock_1") + sm_position(m, "decoy_1")) / 2; },
                     "_A7S_", "_A7S2_"}},
    {"_B6F_", TerminalNode{0}},
    {"_A2F_", TerminalNode{0}},
    {"_A1F_", TerminalNode{0}},
    {"_A5_C1_", Node{[](const SuccessMap &m) { return sm_position(m, "decoy_1"); }, "_A6_C1_", "_A5_C2_"}},
    ...
    {"_A1_C2_", Node{[](const SuccessMap &m) { return sm_position(m, "decoy_1"); }, "_A2_C1_", "_A1_C3_"}},
    ...
    {"START", Node{[](const SuccessMap &m) { return sm_position(m, "decoy_1"); }, "_A2_C1_", "_A1_C2_"}},
    ...
    {"_B4_C1_", Node{[](const SuccessMap &m) { return (sm_position(m, "decoy_1") + sm_position(m, "picklock_1")) / 2; },
                     "_B5_C1_", "_B4_C2_"}}};
};  // namespace tornium::oc::graph
#endif
