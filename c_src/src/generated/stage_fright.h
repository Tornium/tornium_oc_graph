...
{"START", Node([](const SuccessMap &m){ return (m.at("lookout_1") + m.at("muscle_2"))/2; }, "_A2_C1_", "_A1_C2_")},
{"_A1_C2_", Node([](const SuccessMap &m){ return (m.at("lookout_1") + m.at("muscle_1"))/2; }, "_A2_C1_", "_A1_C3_")},
{"_A1_C3_", Node([](const SuccessMap &m){ return (m.at("enforcer_1") + m.at("muscle_3"))/2; }, "_A2_C1_", "_A1F_")},
{"_A2F_", TerminalNode(0)},
{"_A2_C1_", Node([](const SuccessMap &m){ return m.at("sniper_1"); }, "_A3_C1_", "_A2_C2_")},
{"_A2_C2_", Node([](const SuccessMap &m){ return (m.at("muscle_2") + m.at("muscle_1"))/2; }, "_A3_C1_", "_A2F_")},
{"_A3_C1_", Node([](const SuccessMap &m){ return (m.at("muscle_1") + m.at("muscle_3"))/2; }, "_A4_C1_", "_B1_C1_")},
