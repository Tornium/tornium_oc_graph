...
{"_A1_C2_", Node([](const SuccessMap &m){ return (m.at("techie_1") + m.at("engineer_1"))/2; }, "_A2_C1_", "_A1_C3_")},
...
{"_A2_C2_", Node([](const SuccessMap &m){ return (m.at("techie_1") + m.at("thief_1"))/2; }, "_A3_C1_", "_A2_C3_")},
