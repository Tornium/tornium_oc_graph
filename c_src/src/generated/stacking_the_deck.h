...
{"_A1_C2_", Node([](const SuccessMap &m){ return (m.at("cat burglar_1") + m.at("impersonator_1"))/2; }, "_A2_C1_", "_A1F_")},
...
{"_A5_C2_", Node([](const SuccessMap &m){ return m.at("impersonator_1"); }, "_A6S_", "_A5F_")},
{"_A6S_", TerminalNode(0)},
{"_A6_C1_", Node([](const SuccessMap &m){ return m.at("impersonator_1"); }, "_A7S_", "_A6S_")},
{"_A7S_", TerminalNode(0)},
{"_B1F_", TerminalNode(0)},
{"_B1_C1_", Node([](const SuccessMap &m){ return m.at("impersonator_1"); }, "_B2_C1_", "_B1_C2_")},
{"_B1_C2_", Node([](const SuccessMap &m){ return m.at("impersonator_1"); }, "_B2_C1_", "_B1F_")},
{"_B2F_", TerminalNode(0)},
{"_B2_C1_", Node([](const SuccessMap &m){ return m.at("hacker_1"); }, "_B3_C1_", "_B2_C2_")},
{"_B2_C2_", Node([](const SuccessMap &m){ return m.at("impersonator_1"); }, "_B3_C1_", "_B2F_")},
{"_B3F_", TerminalNode(0)},
{"_B3_C1_", Node([](const SuccessMap &m){ return m.at("impersonator_1"); }, "_B4_C1_", "_B3_C2_")},
