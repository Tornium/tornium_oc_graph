...
inline const NodeMap no_reserve{
    ...
    {"_A1_C3_",
     Node([](const SuccessMap &m) { return (m.at("car_thief_1") + m.at("techie_1")) / 2; }, "_A2_C1_", "_A1F_")},
    {"_A2F_", TerminalNode(0)},
    {"_A2_C1_", Node([](const SuccessMap &m) { return m.at("techie_1"); }, "_A3_C1_", "_A2_C2_")},
    {"_A2_C2_",
     Node([](const SuccessMap &m) { return (m.at("techie_1") + m.at("car_thief_1")) / 2; }, "_A3_C1_", "_A2_C3_")},
    ...
    {"_A3_C3_", Node([](const SuccessMap &m) { return m.at("car_thief_1"); }, "_B4_C1_", "_A3F_")},
    {"_A4_C1_", Node([](const SuccessMap &m) { return m.at("car_thief_1"); }, "_A5_C1_", "_B4_C1_")},
    ...
    {"_B5_C1_", Node([](const SuccessMap &m) { return m.at("car_thief_1"); }, "_B8_C1_", "_B5_C2_")},
    {"_B5_C2_", Node([](const SuccessMap &m) { return m.at("techie_1"); }, "_B6_C1_", "_B5F_")},
    {"_B6F_", TerminalNode(0)},
    {"_B6_C1_",
     Node([](const SuccessMap &m) { return (m.at("engineer_1") + m.at("car_thief_1")) / 2; }, "_B7S_", "_B6_C2_")},
    ...
    {"_B8_C2_",
     Node([](const SuccessMap &m) { return (m.at("car_thief_1") + m.at("engineer_1")) / 2; }, "_B8S_", "_B8F_")},
