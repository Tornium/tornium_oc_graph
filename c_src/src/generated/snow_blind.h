...
inline const NodeMap snow_blind{
    ...
    {"_A4_C2_", Node(
                    [](const SuccessMap &m) {
    return (m.at("muscle_1") + m.at("muscle_2") + m.at("hustler_1") + m.at("imitator_1")) / 4;
}, "_A5_C1_", "_A4_C3_")},
    ...
    {"_A5_C2_", Node([](const SuccessMap &m) { return m.at("imitator_1"); }, "_A6_C1_", "_A5F_")},
    {"_A6F_", TerminalNode(0)},
    {"_A6_C1_", Node([](const SuccessMap &m) { return m.at("imitator_1"); }, "_A7_C1_", "_A6_C2_")},
    ...
    {"_A7_C1_", Node([](const SuccessMap &m) { return m.at("imitator_1"); }, "_A8S1_", "_A8S2_")},
    ...
    {"_B7_C1_",
     Node([](const SuccessMap &m) { return (m.at("muscle_1") + m.at("muscle_2")) / 2; }, "_B7S1_", "_B7S2_")},
