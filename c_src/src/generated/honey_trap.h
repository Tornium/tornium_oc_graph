...
inline const NodeMap honey_trap{
    ...
    {"_A4_C2_",
     Node([](const SuccessMap &m) { return (m.at("muscle_1") + m.at("muscle_2")) / 2; }, "_A5_C2_", "_A4F_")},
    ...
    {"_A6_C1_",
     Node([](const SuccessMap &m) { return (m.at("muscle_1") + m.at("muscle_2")) / 2; }, "_A7_C1_", "_A6_C2_")},
    {"_A6_C2_", Node([](const SuccessMap &m) { return m.at("muscle_2"); }, "_A7_C1_", "_A6S_")},
    {"_A7S_", TerminalNode(22866000)},
    {"_A7_C1_",
     Node([](const SuccessMap &m) { return (m.at("enforcer_1") + m.at("muscle_1")) / 2; }, "_A8S_", "_A7S_")},
    ...
    {"_B2_C1_",
     Node([](const SuccessMap &m) { return (m.at("muscle_1") + m.at("muscle_2")) / 2; }, "_B2S_", "_B2_C2_")},
