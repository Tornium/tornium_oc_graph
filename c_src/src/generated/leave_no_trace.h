...
{"_A7_C1_", Node([](const SuccessMap &m){ return (m.at("impersonator_1") + m.at("negotiator_1"))/2; }, "_A7S_", "_A7S2_")},
...
{"_B2_C1_", Node([](const SuccessMap &m){ return (m.at("techie_1") + m.at("negotiator_1"))/2; }, "_B3S_", "_B2F_")},
