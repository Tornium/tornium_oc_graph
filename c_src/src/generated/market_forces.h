...
inline const NodeMap market_forces{
    ...
    {"_A5_C2_",
     Node([](const SuccessMap &m) { return (m.at("enforcer_1") + m.at("lookout_1")) / 2; }, "_A7_C1_", "_A5S_")},
    ...
    {"_B5_C2_",
     Node([](const SuccessMap &m) { return (m.at("enforcer_1") + m.at("lookout_1")) / 2; }, "_B5S_", "_B5F_")}};
};  // namespace tornium::oc::graph
#endif
