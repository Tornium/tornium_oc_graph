...
inline const NodeMap stage_fright{
    ...
    {"START", Node{[](const SuccessMap &m) { return (sm_position(m, "lookout_1") + sm_position(m, "muscle_2")) / 2; },
                   "_A2_C1_", "_A1_C2_"}},
    {"_A1_C2_", Node{[](const SuccessMap &m) { return (sm_position(m, "lookout_1") + sm_position(m, "muscle_1")) / 2; },
                     "_A2_C1_", "_A1_C3_"}},
    {"_A1_C3_", Node{[](const SuccessMap &m) {
    return (sm_position(m, "enforcer_1") + sm_position(m, "muscle_3")) / 2;
}, "_A2_C1_", "_A1F_"}},
    {"_A2F_", TerminalNode{0}},
    {"_A2_C1_", Node{[](const SuccessMap &m) { return sm_position(m, "sniper_1"); }, "_A3_C1_", "_A2_C2_"}},
    {"_A2_C2_", Node{[](const SuccessMap &m) { return (sm_position(m, "muscle_2") + sm_position(m, "muscle_1")) / 2; },
                     "_A3_C1_", "_A2F_"}},
    {"_A3_C1_", Node{[](const SuccessMap &m) { return (sm_position(m, "muscle_1") + sm_position(m, "muscle_3")) / 2; },
                     "_A4_C1_", "_B1_C1_"}},
    ...
    {"_A5_C1_", Node{[](const SuccessMap &m) { return (sm_position(m, "lookout_1") + sm_position(m, "sniper_1")) / 2; },
                     "_A6S_", "_A7S_"}},
    {"_A6S_", TerminalNode{26444400}},
    {"_A7S_", TerminalNode{22037000}},
