...
{"_A4_C2_", Node([](const SuccessMap &m){ return (m.at("techie_1") + m.at("pickpocket_1"))/2; }, "_A5_C1_", "_A4F_")},
...
{"_A6_C2_", Node([](const SuccessMap &m){ return (m.at("imitator_1") + m.at("hacker_1") + m.at("techie_1"))/3; }, "_A8S_", "_A9S_")},
