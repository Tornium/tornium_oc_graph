...
inline const NodeMap guardian_ángels{
    ...
    {"_A1_C3_",
     Node([](const SuccessMap &m) { return (m.at("enforcer_1") + m.at("engineer_1")) / 2; }, "_A2_C1_", "_A1F_")},
    {"_A2F_", TerminalNode(0)},
    {"_A2_C1_", Node([](const SuccessMap &m) { return m.at("engineer_1"); }, "_A3_C1_", "_A2_C2_")},
    {"_A2_C2_",
     Node([](const SuccessMap &m) { return (m.at("enforcer_1") + m.at("engineer_1")) / 2; }, "_A3_C1_", "_A2_C3_")},
    {"_A2_C3_",
     Node([](const SuccessMap &m) { return (m.at("enforcer_1") + m.at("engineer_1")) / 2; }, "_A3_C1_", "_A2F_")},
    ...
    {"_B4_C1_",
     Node([](const SuccessMap &m) { return (m.at("enforcer_1") + m.at("engineer_1")) / 2; }, "_B5_C1_", "_B4_C2_")},
    {"_B4_C2_",
     Node([](const SuccessMap &m) { return (m.at("enforcer_1") + m.at("hustler_1")) / 2; }, "_B5_C1_", "_B4F_")},
