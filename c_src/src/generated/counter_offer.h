...
{"_B4_C2_", Node([](const SuccessMap &m){ return (m.at("engineer_1") + m.at("picklock_1"))/2; }, "_B4_C2P_", "_B4F_")},
...
{"_A5_C2_", Node([](const SuccessMap &m){ return m.at("looter_1"); }, "_A5_C2P_", "_A5_C3_")},
{"_A6_C1_", Node([](const SuccessMap &m){ return (m.at("looter_1") + m.at("engineer_1"))/2; }, "_A6_C1P_", "_A7S2_")},
{"_A2F_", TerminalNode(0)},
{"_A1F_", TerminalNode(0)},
{"_A5_C1_", Node([](const SuccessMap &m){ return (m.at("picklock_1") + m.at("robber_1"))/2; }, "_A5_C1P_", "_A5_C2_")},
...
{"_A3_C1_", Node([](const SuccessMap &m){ return m.at("hacker_1"); }, "_A3_C1P_", "_A3_C2_")},
{"_A1_C2_", Node([](const SuccessMap &m){ return (m.at("robber_1") + m.at("picklock_1"))/2; }, "_A2_C1_", "_A1_C3_")},
{"_A4F_", TerminalNode(0)},
{"_A5_C3_", Node([](const SuccessMap &m){ return (m.at("robber_1") + m.at("looter_1"))/2; }, "_A5_C3P_", "_A5F_")},
...
{"_A3_C2_", Node([](const SuccessMap &m){ return m.at("hacker_1"); }, "_A3_C2P_", "_B3_C1_")},
{"_B3_C2_", Node([](const SuccessMap &m){ return (m.at("engineer_1") + m.at("looter_1"))/2; }, "_B4_C1_", "_B3F_")},
{"_B4_C1_", Node([](const SuccessMap &m){ return m.at("picklock_1"); }, "_B4_C1P_", "_B4_C2_")}
};
};
#endif
