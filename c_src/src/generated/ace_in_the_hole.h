...
inline const NodeMap ace_in_the_hole{
    ...
    {"_C6_C1_", Node([](const SuccessMap &m) { return m.at("imitator_1"); }, "_C7_C1_", "_C6_C2_")},
    {"_B6_C1_", Node([](const SuccessMap &m) { return m.at("hacker_1"); }, "_B7S_", "_B6_C2_")},
    {"_B2_C2_",
     Node([](const SuccessMap &m) { return (m.at("muscle_1") + m.at("muscle_2")) / 2; }, "_B3_C1_", "_B2F_")},
    ...
    {"_C6_C2_",
     Node([](const SuccessMap &m) { return (m.at("muscle_2") + m.at("imitator_1")) / 2; }, "_C9S_", "_C6F_")},
    {"_A4_C1_",
     Node([](const SuccessMap &m) { return (m.at("muscle_1") + m.at("muscle_2")) / 2; }, "_A5_C1_", "_A4_C2_")},
    ...
    {"_A4_C2_", Node([](const SuccessMap &m) { return m.at("imitator_1"); }, "_A5_C1_", "_A4_C3_")},
    ...
    {"_A4_C3_",
     Node([](const SuccessMap &m) { return (m.at("imitator_1") + m.at("muscle_2")) / 2; }, "_A5_C1_", "_A4F_")},
    ...
    {"START", Node([](const SuccessMap &m) { return m.at("imitator_1"); }, "_A2_C1_", "_B2_C1_")},
    {"_D6_C2_", Node([](const SuccessMap &m) { return m.at("hacker_1"); }, "_D7S_", "_D6F_")},
    {"_A2_C1_",
     Node([](const SuccessMap &m) { return (m.at("muscle_1") + m.at("muscle_2")) / 2; }, "_A3_C1_", "_A2_C2_")},
    ...
    {"_B4_C1_",
     Node([](const SuccessMap &m) { return (m.at("muscle_1") + m.at("muscle_2")) / 2; }, "_B5_C1_", "_B4_C2_")},
