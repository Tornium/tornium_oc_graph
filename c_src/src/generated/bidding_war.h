...
{"_A1_C2_", Node([](const SuccessMap &m){ return (m.at("bomber_1") + m.at("bomber_2"))/2; }, "_A2_C1_", "_A1_C3_")},
{"_A1_C3_", Node([](const SuccessMap &m){ return (m.at("driver_1") + m.at("bomber_1"))/2; }, "_A2_C1_", "_A1F_")},
...
{"_A3_C3_", Node([](const SuccessMap &m){ return (m.at("robber_1") + m.at("robber_2"))/2; }, "_A4_C1_", "_A3F_")},
{"_A4F2_", TerminalNode(0)},
{"_A4F_", TerminalNode(0)},
{"_A4_C1_", Node([](const SuccessMap &m){ return m.at("robber_3"); }, "_A4_4_", "_A4_C2_")},
{"_A4_C2_", Node([](const SuccessMap &m){ return m.at("bomber_2"); }, "_A4_4_", "_A4_C3_")},
...
{"_A6_C1_", Node([](const SuccessMap &m){ return (m.at("robber_3") + m.at("driver_1"))/2; }, "_A7_C1_", "_A6_C2_")},
