...
{"_A2_C2_", Node([](const SuccessMap &m){ static_assert(false, "Missing data: This needs to be manually entered"); }, "_A3_C1_", "_B1_C1_")},
...
{"_C1_C1_", Node([](const SuccessMap &m){ return m.at("picklock_1"); }, "_C3S_", "_C1F_")},
