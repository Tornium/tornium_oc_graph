...
{"_A1_C2_", Node([](const SuccessMap &m){ return m.at("engineer_1"); }, "_A2_C1_", "_A1_C3_")},
{"_A1_C3_", Node([](const SuccessMap &m){ return m.at("thief_1"); }, "_A2_C1_", "_A1F_")},
...
{"_A3_C1_", Node([](const SuccessMap &m){ static_assert(false, "Missing data: This needs to be manually entered"); }, "_A4_C1_", "_A3_C2_")},
...
{"_A6_C1_", Node([](const SuccessMap &m){ static_assert(false, "Missing data: This needs to be manually entered"); }, "_A7S_", "_B8_C1_")},
...
{"_B6_C1_", Node([](const SuccessMap &m){ return (m.at("engineer_1") + m.at("thief_1"))/2; }, "_B7S_", "_B6_C2_")},
{"_B6_C2_", Node([](const SuccessMap &m){ static_assert(false, "Missing data: This needs to be manually entered"); }, "_B7S_", "_B6F_")},
{"_B7S_", TerminalNode(0)},
{"_B8F_", TerminalNode(0)},
{"_B8S_", TerminalNode(0)},
{"_B8_C1_", Node([](const SuccessMap &m){ static_assert(false, "Missing data: This needs to be manually entered"); }, "_B9S_", "_B8_C2_")},
