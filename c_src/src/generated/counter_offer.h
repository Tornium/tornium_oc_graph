...
inline const NodeMap counter_offer{
    ...
    {"_A1_C2_",
     Node([](const SuccessMap &m) { return (sm_position(m, "robber_1") + sm_position(m, "picklock_1")) / 2; },
          "_A2_C1_", "_A1_C3_")},
    {"_A1_C3_",
     Node([](const SuccessMap &m) { return (sm_position(m, "looter_1") + sm_position(m, "picklock_1")) / 2; },
          "_A2_C1_", "_A1F_")},
    ...
    {"_B3_C2_",
     Node([](const SuccessMap &m) { return (sm_position(m, "engineer_1") + sm_position(m, "looter_1")) / 2; },
          "_B4_C1_", "_B3F_")},
