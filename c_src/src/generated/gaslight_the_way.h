...
inline const NodeMap gaslight_the_way{
    ...
    {"START",
     Node([](const SuccessMap &m) { return (m.at("imitator_1") + m.at("looter_1")) / 2; }, "_A2_C1_", "_A1_C2_")},
    {"_A1_C2_",
     Node([](const SuccessMap &m) { return (m.at("imitator_1") + m.at("looter_1")) / 2; }, "_A2_C1_", "_A1_C3_")},
    {"_A1_C3_",
     Node([](const SuccessMap &m) { return (m.at("imitator_1") + m.at("looter_1")) / 2; }, "_A2_C1_", "_A1F_")},
    ...
    {"_A5_C1_",
     Node([](const SuccessMap &m) { return (m.at("looter_2") + m.at("looter_3")) / 2; }, "_A7_C1_", "_B7_C1_")},
    {"_A7S2_", TerminalNode(700)},
    {"_A7S_", TerminalNode(700)},
    {"_A7_C1_", Node([](const SuccessMap &m) { return m.at("imitator_2"); }, "_A7S_", "_A7S2_")},
    {"_B7S2_", TerminalNode(700)},
    {"_B7S_", TerminalNode(700)},
