...
inline const NodeMap blast_from_the_past{
    ...
    {"_A1_C2_",
     Node([](const SuccessMap &m) { return (m.at("picklock_1") + m.at("picklock_2")) / 2; }, "_A2_C1_", "_A1_C3_")},
    ...
    {"_A2_C3_",
     Node([](const SuccessMap &m) { return (m.at("picklock_1") + m.at("hacker_1")) / 2; }, "_A3_C1_", "_A2F_")},
    ...
    {"_A4_C2_",
     Node([](const SuccessMap &m) { return (m.at("muscle_1") + m.at("engineer_1")) / 2; }, "_A5_C1_", "_A4F_")},
    {"_A5F_", TerminalNode(0)},
    {"_A5_C1_", Node([](const SuccessMap &m) { return m.at("bomber_1"); }, "_A6_C1_", "_A5_C2_")},
    {"_A5_C2_",
     Node([](const SuccessMap &m) { return (m.at("engineer_1") + m.at("bomber_1")) / 2; }, "_B6_C1_", "_A5F_")},
    {"_A6_C1_", Node([](const SuccessMap &m) { return m.at("picklock_2"); }, "_A7_C1_", "_A6_C2_")},
    {"_A6_C2_",
     Node([](const SuccessMap &m) { return (m.at("engineer_1") + m.at("picklock_2")) / 2; }, "_A7_C1_", "_B6_C1_")},
