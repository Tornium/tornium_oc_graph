...
inline const NodeMap clinical_precision{
    ...
    {"_A1_C3_",
     Node([](const SuccessMap &m) { return (m.at("cat burglar_1") + m.at("cleaner_1")) / 2; }, "_A2_C1_", "_A1F_")},
    ...
    {"_C5_C2_",
     Node([](const SuccessMap &m) { return (m.at("cat burglar_1") + m.at("cleaner_1")) / 2; }, "_C6_C1_", "_C5F_")},
    {"_B4F_", TerminalNode(0)},
    {"_A3_C1_", Node([](const SuccessMap &m) { return m.at("cleaner_1"); }, "_A4_C1_", "_A3_C2_")},
    {"_A8S_", TerminalNode(115652000)},
    {"_A1_C2_",
     Node([](const SuccessMap &m) { return (m.at("assassin_1") + m.at("cat burglar_1")) / 2; }, "_A2_C1_", "_A1_C3_")},
