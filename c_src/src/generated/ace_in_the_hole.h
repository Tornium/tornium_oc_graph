...
inline const NodeMap ace_in_the_hole{
    ...
    {"_C6_C2_",
     Node([](const SuccessMap &m) { return (m.at("muscle_2") + m.at("impersonator_1")) / 2; }, "_C9S_", "_C6F_")},
    {"_A4_C1_",
    ...
    {"_A4_C3_",
     Node([](const SuccessMap &m) { return (m.at("impersonator_1") + m.at("muscle_2")) / 2; }, "_A5_C1_", "_A4F_")},
