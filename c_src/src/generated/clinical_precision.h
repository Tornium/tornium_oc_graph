...
inline const NodeMap clinical_precision{
    ...
    {"_A1_C3_",
     Node([](const SuccessMap &m) { return (m.at("cat_burglar_1") + m.at("cleaner_1")) / 2; }, "_A2_C1_", "_A1F_")},
    ...
    {"_A5_C1_",
     Node([](const SuccessMap &m) { return (m.at("imitator_1") + m.at("assassin_1")) / 2; }, "_A6_C1_", "_C5_C1_")},
    {"_C6F_", TerminalNode(0)},
    {"_A4_C2_", Node([](const SuccessMap &m) { return m.at("cat_burglar_1"); }, "_A5_C1_", "_A4F_")},
    {"_C5_C2_",
     Node([](const SuccessMap &m) { return (m.at("cat_burglar_1") + m.at("cleaner_1")) / 2; }, "_C6_C1_", "_C5F_")},
    {"_B4F_", TerminalNode(0)},
    {"_A3_C1_", Node([](const SuccessMap &m) { return m.at("cleaner_1"); }, "_A4_C1_", "_A3_C2_")},
    {"_A8S_", TerminalNode(115652000)},
    {"_A1_C2_",
     Node([](const SuccessMap &m) { return (m.at("assassin_1") + m.at("cat_burglar_1")) / 2; }, "_A2_C1_", "_A1_C3_")},
    {"_A4F_", TerminalNode(0)},
    {"_A6F_", TerminalNode(0)},
    {"_A7_C1_",
     Node([](const SuccessMap &m) { return (m.at("assassin_1") + m.at("cleaner_1")) / 2; }, "_A8S_", "_A9S_")},
    {"_B5_C1_",
     Node([](const SuccessMap &m) { return (m.at("cleaner_1") + m.at("assassin_1")) / 2; }, "_B6S_", "_B5S_")},
    ...
    {"_B3_C2_",
     Node([](const SuccessMap &m) { return (m.at("assassin_1") + m.at("cleaner_1")) / 2; }, "_B4_C1_", "_B3F_")},
