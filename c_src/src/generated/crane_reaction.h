...
inline const NodeMap crane_reaction{
    ...
    {"_A7_C3_", Node(
                    [](const SuccessMap &m) {
    return (sm_position(m, "muscle_1") + sm_position(m, "muscle_2") + sm_position(m, "engineer_1")) / 3;
}, "_A8S3_", "_A7F_")},
    {"_A3F_", TerminalNode(0)},
    {"_A4_C1_", Node(
                    [](const SuccessMap &m) {
    return (sm_position(m, "sniper_1") + sm_position(m, "lookout_1") + sm_position(m, "muscle_1") +
            sm_position(m, "muscle_2")) /
           4;
}, "_A5_C1_", "_A4_C2_")},
    {"_A5_C2_",
     Node([](const SuccessMap &m) { return (sm_position(m, "engineer_1") + sm_position(m, "bomber_1")) / 2; },
          "_A6_C1_", "_B5_C1_")},
    {"_A6_C1_", Node([](const SuccessMap &m) { return (sm_position(m, "sniper_1") + sm_position(m, "lookout_1")) / 2; },
                     "_A7_C1_", "_A6_C2_")},
    ...
    {"_B7_C1_", Node(
                    [](const SuccessMap &m) {
    return (sm_position(m, "muscle_1") + sm_position(m, "muscle_2") + sm_position(m, "engineer_1") +
            sm_position(m, "bomber_1") + sm_position(m, "lookout_1") + sm_position(m, "sniper_1")) /
           6;
}, "_B7S_", "_B7_C2_")},
    ...
    {"_A8S_", TerminalNode(1260000000)},
    {"_B7S2_", TerminalNode(420000000)},
    ...
    {"_A7_C1_", Node([](const SuccessMap &m) { return (sm_position(m, "muscle_2") + sm_position(m, "muscle_1")) / 2; },
                     "_A8S_", "_A7_C2_")},
    {"_A7F_", TerminalNode(0)},
    {"_B5_C1_",
     Node([](const SuccessMap &m) { return (sm_position(m, "engineer_1") + sm_position(m, "bomber_1")) / 2; },
          "_B6_C1_", "_B5_C2_")},
    {"_A2_C2_", Node([](const SuccessMap &m) { return (sm_position(m, "sniper_1") + sm_position(m, "driver_1")) / 2; },
                     "_A3_C1_", "_A2F_")},
    {"START", Node([](const SuccessMap &m) { return (sm_position(m, "muscle_1") + sm_position(m, "muscle_2")) / 2; },
                   "_A2_C1_", "_A1_C2_")},
    {"_A2_C1_",
     Node([](const SuccessMap &m) { return (sm_position(m, "lookout_1") + sm_position(m, "engineer_1")) / 2; },
          "_A3_C1_", "_A2_C2_")},
    {"_A3_C2_", Node([](const SuccessMap &m) { return (sm_position(m, "sniper_1") + sm_position(m, "bomber_1")) / 2; },
                     "_A4_C1_", "_A3F_")},
    {"_B7S_", TerminalNode(840000000)},
